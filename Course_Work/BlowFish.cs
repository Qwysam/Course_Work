...
namespace BlowFish_namespace
{
    ...
    public class BlowFish
    {
        ...
        private byte[] initVector = { 15, 27, 39, 41, 56, 66, 79, 90 };
        /// <summary>
        ...
        {
            return ByteToHex(this.initVector) + ByteToHex(this.EncryptCBC(Encoding.UTF8.GetBytes(pt)));
        }
        ...
        public string DecryptCBC(string ct)
        {
            ...
            return Encoding.UTF8.GetString(this.DecryptCBC(HexToByte(ct.Substring(16)))).Replace("\0", string.Empty);
        }
